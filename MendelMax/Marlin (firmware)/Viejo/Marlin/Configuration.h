...
// MAK3R LABS customized firmware for VLC30 model.
...
#define HOMING_FEEDRATE {60*60, 60*60, 1*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,62.89}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {255, 255, 2, 30}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {700,700,5,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
